...
### [WLToys K969 — кузов](wltoys_k969_shell/)

Кузов спорткара для RC-модели WLToys K969 (масштаб 1:28). Тонкостенная оболочка, описанная поперечными сечениями.

- `body_shell.scad` — параметрическая модель с профилями кузова и кабины

---

### [LDRC — кузов хэтчбек](ldrc_car/)

Кузов хэтчбека для RC-модели LDRC (масштаб 1:28).

- `body_shell.scad` — параметрическая модель с колёсными арками и крепёжными стойками
